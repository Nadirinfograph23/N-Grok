export const LOAD_HEADERS: Record<string, string> = {
...
export const C_REQUEST_HEADERS: Record<string, string> = {
  "sec-ch-ua-platform": '"Windows"',
  "next-action": "",
  "sec-ch-ua":
    '"Google Chrome";v="143", "Chromium";v="143", "Not A(Brand";v="24"',
...
export const CONVERSATION_HEADERS: Record<string, string> = {
  "x-xai-request-id": "",
  "sec-ch-ua-platform": '"Windows"',
  "sec-ch-ua":
    '"Google Chrome";v="143", "Chromium";v="143", "Not A(Brand";v="24"',
